...
class ApplicationMVA(Application):
    ...
    JMTPath="%s/JMT/JMT_1.1.1.jar"%(os.path.dirname(os.path.dirname(pathlib.Path(__file__).absolute())))
    
    def __init__(self,sla=1.0, disturbance=0.1,stime=1.0):
